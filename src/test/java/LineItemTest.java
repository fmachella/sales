...
public class LineItemTest {
    ...
    public void shouldRoundUpTo5() throws Exception {
        Item imported_bottle=Item.create("imported bottle of perfume",BigDecimal.valueOf(47.50));
        ...
        Item imported_lollo=Item.create("imported bottle of lollo",BigDecimal.valueOf(30.75));
